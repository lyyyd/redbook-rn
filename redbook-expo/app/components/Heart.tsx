...
// import icon_heart_empty from "../../assets/img/icon_heart_empty.png";

const icon_heart = require("../../assets/img/icon_heart.png");
const icon_heart_empty = require("../../assets/img/icon_heart_empty.png");
