...
const ICON_PLAY_BUTTON = new Icon(
    require("@/assets/audio/images/play_button.png"),
    34,
    51
);
const ICON_PAUSE_BUTTON = new Icon(
    require("@/assets/audio/images/pause_button.png"),
    34,
    51
);
const ICON_STOP_BUTTON = new Icon(
    require("@/assets/audio/images/stop_button.png"),
    22,
    22
);
const ICON_FORWARD_BUTTON = new Icon(
    require("@/assets/audio/images/forward_button.png"),
    33,
    25
);
const ICON_BACK_BUTTON = new Icon(
    require("@/assets/audio/images/back_button.png"),
    33,
    25
);

const ICON_LOOP_ALL_BUTTON = new Icon(
    require("@/assets/audio/images/loop_all_button.png"),
    77,
    35
);
const ICON_LOOP_ONE_BUTTON = new Icon(
    require("@/assets/audio/images/loop_one_button.png"),
    77,
    35
);

const ICON_MUTED_BUTTON = new Icon(
    require("@/assets/audio/images/muted_button.png"),
    67,
    58
);
const ICON_UNMUTED_BUTTON = new Icon(
    require("@/assets/audio/images/unmuted_button.png"),
    67,
    58
);

const ICON_TRACK_1 = new Icon(require("@/assets/audio/images/track_1.png"), 166, 5);
const ICON_THUMB_1 = new Icon(require("@/assets/audio/images/thumb_1.png"), 18, 19);
const ICON_THUMB_2 = new Icon(require("@/assets/audio/images/thumb_2.png"), 15, 19);
    ...
    componentDidMount() {
        ...
        (async () => {
            await Font.loadAsync({
                ...MaterialIcons.font,
                "cutive-mono-regular": require("@/assets/audio/fonts/CutiveMono-Regular.ttf")
            });
