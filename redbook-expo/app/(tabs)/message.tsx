...
// import icon_new_follow from '@/assets/img/icon_new_follow.png';
// import icon_comments from '@/assets/img/icon_comments.png';
// import icon_group from '@/assets/img/icon_group.png';
// import icon_to_top from '@/assets/img/icon_to_top.png';
// import icon_no_collection from '@/assets/img/icon_no_collection.webp';
const icon_star = require('@/assets/img/icon_star.png');
const icon_new_follow = require('@/assets/img/icon_new_follow.png');
const icon_comments = require('@/assets/img/icon_comments.png');
const icon_group = require('@/assets/img/icon_group.png');
const icon_to_top = require('@/assets/img/icon_to_top.png');
